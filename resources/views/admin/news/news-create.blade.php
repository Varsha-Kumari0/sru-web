                    ...
                    @forelse($recentUpdatedNews as $recentNews)
                        <div class="rounded-xl border border-slate-200 bg-slate-50 px-4 py-3">
                            <div class="flex items-start justify-between gap-3">
                                <div>
                                    <p class="text-sm font-semibold text-slate-900">{{ $recentNews->title }}</p>
                                    <p class="mt-1 line-clamp-2 text-xs text-slate-600">{{ $recentNews->excerpt }}</p>
                                </div>
                                <span class="rounded-md bg-blue-50 px-2 py-1 text-[11px] font-semibold text-blue-700">Updated</span>
                            </div>
