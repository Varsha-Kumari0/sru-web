    ...
    <div class="min-h-screen" style="background: #f0f0ee;">
        ...
        @if($profile)
            ...
            <div class="sru-hero-gradient relative overflow-hidden" style="height: 200px;">
                ...
                <div class="absolute -bottom-20 right-10 w-96 h-96 rounded-full" style="background:rgba(255,255,255,0.03);">
                </div>
            ...
            <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                : 'data:image/svg+xml;utf8,<svg xmlns=%22http://www.w3.org/2000/svg%22 width=%22150%22 height=%22150%22 viewBox=%220 0 150 150%22><rect width=%22150%22 height=%22150%22 fill=%22%231a2d4a%22/><circle cx=%2275%22 cy=%2250%22 r=%2226%22 fill=%22%23ffffff33%22/><path d=%22M30 125c5-22 25-37 45-37s40 15 45 37%22 fill=%22%23ffffff33%22/></svg>' }}"
                                ...
                                <div class="flex-1 min-w-0">
                                    <p class="text-xs font-bold uppercase tracking-widest mb-1" style="color: #2a9d8f;">SRU
                                        Alumni</p>

                                    <h1 class="text-2xl md:text-3xl font-bold tracking-tight" style="color: #1a2d4a;">
                                    ...
                                    <div class="flex flex-wrap gap-2 mt-3">
                                        ...
                                        @endif
                                        <span
                                            class="px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wide text-white"
                                ...
                                <div class="shrink-0 space-y-3" style="min-width: 210px;">
                                    <div class="rounded-xl border p-4" style="background:#f8fffe; border-color:#b2ece5;">
                                        <p class="text-xs font-bold uppercase tracking-widest mb-3" style="color:#94a3b8;">
                                            Profile Status</p>
                                        <div class="flex flex-wrap gap-2">
                                            <span
                                                class="inline-flex items-center gap-1.5 rounded-full px-4 py-1.5 text-xs font-bold text-white"
                                            ...
                                            <span
                                                class="inline-flex items-center rounded-full px-4 py-1.5 text-xs font-bold text-white"
                    ...
                    <div class="lg:col-span-2 space-y-6">
                        ...
                        <div class="sru-card bg-white rounded-2xl border border-gray-100 p-6 shadow-sm fade-up fu3">
                                ...
                                <div class="sru-teal-left mb-5 last:mb-0 py-1">
                                    <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-1">
                                        <div>
                                            ...
                                            <p class="text-sm font-medium mt-0.5" style="color: #2a9d8f;">{{ $exp->organization }}
                                            </p>
                                            @if($exp->location)
                            ...
                            @empty
                                <div class="text-center py-8">
                                    <svg class="w-12 h-12 mx-auto mb-3" style="color: #d1d5db;" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                    ...
                                    <a href="{{ route('profile.edit') }}"
                                        class="mt-1 inline-block text-sm font-semibold hover:underline" style="color: #2a9d8f;">
                                        Add experience →
                                    </a>
                                </div>
                            @endforelse
                            ...
                            @if($skills && count($skills) > 0)
                                <div class="flex flex-wrap gap-2">
                                    @foreach($skills as $skill)
                                        <span
                                            class="sru-skill-pill inline-flex items-center gap-2 px-3 py-1.5 rounded-full border text-sm font-medium"
                        ...
                        <div class="sru-card bg-white rounded-2xl border border-gray-100 p-6 shadow-sm fade-up fu5">
                            <div class="flex justify-between items-center mb-5">
                                <h2 class="sru-section-label">Achievements</h2>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                    ...
                                    <div class="sru-achievement-card flex gap-4 p-4 rounded-xl border"
                                        ...
                                        <div class="min-w-0">
                                            ...
                                            @if($achievement->earned_at)
                                                <p class="text-[10px] font-bold mt-1.5 uppercase tracking-wide" style="color: #c9a84c;">
                                ...
                                @empty
                                    <div class="col-span-2 text-center py-6">
                                        <p class="text-sm" style="color: #94a3b8;">No achievements added yet.</p>
                                        <a href="{{ route('achievements.create') }}"
                                            class="mt-1 inline-block text-sm font-semibold hover:underline" style="color: #2a9d8f;">
                                ...
                                @if($profile->user && $profile->user->email)
                                    <a href="mailto:{{ $profile->user->email }}"
                                        ...
                                        <span class="text-sm font-medium truncate"
                                            style="color: #334155;">{{ $profile->user->email }}</span>
                                    </a>
                                @endif
                            </div>
                        </div>
                            ...
                            <div class="rounded-xl border p-4 sru-achievement-card"
                                ...
                                <div class="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs font-semibold mt-0.5" style="color: #2a9d8f;">
                                            {{ $profile->branch ?? '—' }}</p>
